...
FOR EACH ttOrbit WHERE ttOrbit.cCenter <> "COM":
    ...
    DO WHILE TRUE:
        ...
        ttOrbit.iChkSum = ttOrbit.iChkSum + 1.
        IF bttOrbit.cCenter = "COM" THEN LEAVE.
        cCenter = bttOrbit.cCenter.
    END.
    iTotal = iTotal + ttOrbit.iChkSum.
END.

MESSAGE ETIME SKIP iTotal
